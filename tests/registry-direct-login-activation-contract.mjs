...
assert.match(loginPage,/Sign in directly with your staff number or official email and password/);
...
assert.doesNotMatch(registrationPage,/activation key|email confirmation/i);
